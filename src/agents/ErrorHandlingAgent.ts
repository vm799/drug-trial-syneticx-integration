...
export class ErrorHandlingAgent extends BaseAgent {
    ...
    const translations: ErrorTranslation[] = [
      {
        ...
        userMessage: 'Our AI assistant is experiencing high demand right now. We\'re switching to our backup research database to help you.',
        suggestedAction: 'Try your query again - we\'ll use cached research data to provide helpful information.',
        recoveryOptions: [
      ...
      },
      {
        ...
        userMessage: 'PubMed is responding slowly right now. Let me search our local research collection instead.',
      ...
      },
      {
        ...
        userMessage: 'There seems to be a connection issue. Don\'t worry - I can still help using our offline research database.',
      ...
      },
      {
        ...
        suggestedAction: 'I\'ll use our internal database to find relevant medical research for you.',
        recoveryOptions: [
      ...
      },
      {
        ...
        userMessage: 'Our database is temporarily unavailable. I\'ll provide information from backup sources.',
      ...
      },
      {
        ...
        suggestedAction: 'Try asking about specific medical topics, research findings, or clinical trials.',
        recoveryOptions: [
  ...
  private translateError(errorType: string, originalError: any): ErrorTranslation {
    ...
    return {
      ...
      userMessage: 'Something unexpected happened, but I can still help you with your research questions.',
  ...
  private async generateFallbackResponse(context: AgentContext, errorType: string): Promise<string | null> {
    ...
    if (lastMessage.toLowerCase().includes('summary') || lastMessage.toLowerCase().includes('summarize')) {
    ...
    if (lastMessage.toLowerCase().includes('clinical trial') || lastMessage.toLowerCase().includes('study')) {
    ...
    if (lastMessage.toLowerCase().includes('drug') || lastMessage.toLowerCase().includes('medication')) {
